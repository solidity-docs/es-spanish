...
Solidity es un `lenguaje de llaves`. Diseñado para la máquina virtual de Ethereum (Ethereum Virtual Machine). Está influenciado por los lenguajes de programación C++, Python y JavaScript.
