...
- Se puede sospechar altamente si un contrato se compiló con un compilador que contiene un bug conocido; el contrato se creó en un momento en el que ya se había lanzado una versión más reciente del compilador que ya contenía una corrección.
